  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-16 text-center">
        <ScrollReveal>
          <span className="label-editorial text-brand-red">Contact</span>
        </ScrollReveal>

        <TextReveal
          as="h2"
          className="mt-6 font-serif text-[clamp(1.5rem,3vw,2.5rem)] font-light leading-[1.4] tracking-[0.02em]"
          delay={0.1}
        >
          {"あなたのプロジェクトも、\nストーリーに。"}
        </TextReveal>
        ...
        <ScrollReveal delay={0.4}>
          <div className="mt-12">
            ...
            >
              <span
                className={`w-12 h-px group-hover:w-20 transition-all duration-500 ${
                  isDark
                    ? "bg-white/30 group-hover:bg-white"
                    : "bg-brand-red/30 group-hover:bg-brand-red"
                }`}
              />
              お問い合わせ
            </Link>
