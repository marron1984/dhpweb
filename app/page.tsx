    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="order-2 lg:order-1">
              <ScrollReveal delay={0.1}>
                <p className="label-editorial text-brand-red mb-10">
              ...
              <TextReveal
                as="h1"
                className="font-serif text-[clamp(2.5rem,5vw,4.5rem)] font-light leading-[1.2] tracking-[0.02em]"
                delay={0.2}
              >
                {"価値創造の\nプロセスを、\n物語として。"}
              </TextReveal>
      ...
      <section className="py-20 lg:py-28 px-6 lg:px-16 relative">
        <div className="max-w-[1400px] mx-auto">
          <div className="max-w-4xl">
            ...
            <TextReveal
              as="h2"
              className="mt-6 font-serif text-[clamp(1.5rem,3.5vw,3rem)] font-light leading-[1.5] tracking-[0.02em]"
              delay={0.1}
            >
              {"実績を並べるのではなく、\n物語を伝える。\nそれが、私たちの選んだ方法です。"}
            </TextReveal>
      ...
      <section className="py-20 lg:py-28 px-6 lg:px-16 bg-cream">
        <div className="max-w-[1400px] mx-auto">
          ...
          <ScrollReveal delay={0.2} className="mt-12 lg:hidden text-center">
            <Link
              href="/projects"
          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            <StaggerChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8" staggerDelay={0.12}>
              {otherProjects.map((project, i) => (
                <StaggerItem key={project.slug}>
                  <ProjectStoryCard project={project} index={i} />
                </StaggerItem>
              ))}
            </StaggerChildren>
          </div>
